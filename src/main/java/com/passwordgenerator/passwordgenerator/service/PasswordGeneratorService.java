...
public class PasswordGeneratorService {
    ...
    public Map<String, String> generatePasswordResponse (Integer passwordLength) {
        ...
        passwordGeneratedResponse.put("passwordGenerated", PasswordGenerator.generate(passwordLength));
